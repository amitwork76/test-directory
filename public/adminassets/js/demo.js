    ...
    showSwal: function(type,id='') {
        if (type == 'basic') {
            ...
            swal({
                ...
                html: '<div class="form-group">' +
                    '<select id="payment-status" class="form-control" name="payment_status"> <option value="0">Pending</option> <option value="1">Completed</option> <option value="2">Inprocess</option> </select>' +
                    '</div>',
                showCancelButton: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger',
                ...
                {
                    $.ajax({
                            url: site_url+'/admin/paymentStatus/'+id+'/'+status,
                            method:"get",
                            ...
                            {                        
                                if(data=='success')
                                {
                                    $.get(window.location.href, function(data){
                                        $('#datatables111').html($(data).find('#datatables111').html());
                                        var message = 'Payment status changed successfully.';
            ...
            swal({
                ...
                html: '<div class="form-group">' +
                    '<select id="order-status" class="form-control" name="payment_status"> <option value="0">In Process</option><option value="4">Accept</option> <option value="1">Deliverd</option> <option value="2">Cancel</option><option value="3">Return</option> </select>' +
                    '</div>',
                showCancelButton: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger',
                ...
                {
                    $.ajax({
                            url: site_url+'/admin/orderStatus/'+id+'/'+status,
                            method:"get",
                            success:function(data)
                            {                        
                                if(data=='success')
